...
class Post extends Model {
  ...
  String toString() {
    ...
    buffer.write("isImported=" + (_isImported != null ? _isImported!.toString() : "null") + ", ");
  ...
  static final QueryField ISIMPORTED = QueryField(fieldName: "isImported");
